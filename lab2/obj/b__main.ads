...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#e74c86c4#;
   ...
   u00082 : constant Version_32 := 16#e8ab0276#;
   pragma Export (C, u00082, "lab2B");
   u00083 : constant Version_32 := 16#2b61f9dd#;
   pragma Export (C, u00083, "lab2S");
   u00084 : constant Version_32 := 16#cd2959fb#;
   pragma Export (C, u00084, "ada__numericsS");
   u00085 : constant Version_32 := 16#d976e2b4#;
   pragma Export (C, u00085, "ada__numerics__float_randomB");
   u00086 : constant Version_32 := 16#62aa8dd2#;
   pragma Export (C, u00086, "ada__numerics__float_randomS");
   u00087 : constant Version_32 := 16#ec9cfed1#;
   pragma Export (C, u00087, "system__random_numbersB");
   u00088 : constant Version_32 := 16#cb43df61#;
   pragma Export (C, u00088, "system__random_numbersS");
   u00089 : constant Version_32 := 16#ec78c2bf#;
   pragma Export (C, u00089, "system__img_unsB");
   u00090 : constant Version_32 := 16#a3292f8f#;
   pragma Export (C, u00090, "system__img_unsS");
   u00091 : constant Version_32 := 16#650caaea#;
   pragma Export (C, u00091, "system__random_seedB");
   u00092 : constant Version_32 := 16#534b46a0#;
   pragma Export (C, u00092, "system__random_seedS");
   u00093 : constant Version_32 := 16#b8719323#;
   pragma Export (C, u00093, "ada__calendarB");
   u00094 : constant Version_32 := 16#41508869#;
   pragma Export (C, u00094, "ada__calendarS");
   u00095 : constant Version_32 := 16#769e25e6#;
   pragma Export (C, u00095, "interfaces__cB");
   u00096 : constant Version_32 := 16#467817d8#;
   pragma Export (C, u00096, "interfaces__cS");
   u00097 : constant Version_32 := 16#2b2125d3#;
   pragma Export (C, u00097, "system__os_primitivesB");
   u00098 : constant Version_32 := 16#0fa60a0d#;
   ...
   u00100 : constant Version_32 := 16#2c75fe43#;
   ...
   u00107 : constant Version_32 := 16#8aa4f090#;
   pragma Export (C, u00107, "system__img_realB");
   u00108 : constant Version_32 := 16#cff33e19#;
   pragma Export (C, u00108, "system__img_realS");
   u00109 : constant Version_32 := 16#0cccd408#;
   pragma Export (C, u00109, "system__fat_llfS");
   u00110 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00110, "system__float_controlB");
   u00111 : constant Version_32 := 16#e8a72cc7#;
   pragma Export (C, u00111, "system__float_controlS");
   u00112 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00112, "system__img_lluB");
   u00113 : constant Version_32 := 16#751413bb#;
   pragma Export (C, u00113, "system__img_lluS");
   u00114 : constant Version_32 := 16#582b098c#;
   ...
   u00116 : constant Version_32 := 16#fd821e10#;
   pragma Export (C, u00116, "system__img_boolS");
   u00117 : constant Version_32 := 16#2323a8af#;
   pragma Export (C, u00117, "system__memoryB");
   u00118 : constant Version_32 := 16#512609cf#;
